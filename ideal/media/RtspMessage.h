...
*   File Name     : RtspMessage.h
*   Last Modified : 2019-12-02 19:03
*   Describe      :
*
*******************************************************/

#ifndef  _IDEAL_MEDIA_RTSPMESSAGE_H
#define  _IDEAL_MEDIA_RTSPMESSAGE_H
...
public:
    ...
    bool parseRequest(ideal::net::Buffer* buffer);
...
public:
    ...
    bool parseResponse(ideal::net::Buffer* buffer);
...
#endif // _IDEAL_MEDIA_RTSPMESSAGE_H
