...
*   File Name     : RtpConnection.h
*   Last Modified : 2019-12-02 14:57
*   Describe      :
*
*******************************************************/

#ifndef  _IDEAL_MEDIA_RTPCONNECTION_H
#define  _IDEAL_MEDIA_RTPCONNECTION_H
...
class RtpConnection {
public:
    RtpConnection(const ideal::net::TcpConnectionPtr& tcpConn);
    ~RtpConnection();
...
private:
    std::weak_ptr<ideal::net::TcpConnection> _tcpConn;
...
#endif // _IDEAL_MEDIA_RTPCONNECTION_H
