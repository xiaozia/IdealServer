...
*   File Name     : RtspMessage.cc
*   Last Modified : 2019-12-02 19:12
*   Describe      :
*
*******************************************************/
...
bool RtspRequest::parseRequest(ideal::net::Buffer* buffer) {
...
bool RtspResponse::parseResponse(ideal::net::Buffer* buffer) { // TODO
